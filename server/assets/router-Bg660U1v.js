...
const appCss = "/assets/styles-C-Uf7g31.css";
function NotFoundComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-7xl font-bold text-foreground", children: "404" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mt-4 text-xl font-semibold text-foreground", children: "페이지를 찾을 수 없습니다" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "요청하신 페이지가 존재하지 않거나 이동되었습니다." }),
...
function ErrorComponent({ error, reset }) {
  ...
  const router2 = useRouter();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex min-h-screen items-center justify-center bg-background px-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-md text-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold tracking-tight text-foreground", children: "페이지를 불러오지 못했습니다" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-muted-foreground", children: "잠시 후 다시 시도해 주세요." }),
...
const ORG_JSONLD$1 = {
  ...
  url: "/",
  email: "hello@rgeo.ai",
  description: "초기 비용 0원부터 시작 가능한 월 구독형 외주개발 서비스. 웹·앱·MVP 개발과 GEO·SEO 최적화를 동시에 설계하는 기술 투자 동반자.",
  sameAs: []
};
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "RGEO Labs는 초기 비용 0원부터 시작 가능한 월 구독형 외주개발 서비스입니다. 웹·앱·MVP 개발과 GEO·SEO 최적화를 한 팀이 함께 설계합니다."
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify(ORG_JSONLD$1)
      }
    ]
  }),
...
const faqs = [{
  ...
  a: "RGEO Labs(알지오랩스)는 개발자 채용 없이 웹·앱·AI 서비스를 시작할 수 있도록 돕는 AI 시대의 기술 운영 파트너입니다. 기술 투자, 개발 투자, 월 구독형 개발 구조를 기반으로 초기 서비스 출시의 문턱을 낮추고 빠른 MVP 검증이 가능하도록 설계합니다. 웹사이트 제작, 앱 개발, 유지보수, AI 자동화, GEO·SEO 최적화까지 하나의 팀으로 함께하며, 단순 제작보다 출시 이후 운영과 AI 검색 노출 구조까지 함께 고려합니다. 또한 ChatGPT, Google, Perplexity 같은 AI 검색 환경에서 브랜드와 서비스가 더 잘 이해되고 발견될 수 있도록 구조화된 개발 방식을 지향합니다."
}, {
  q: "왜 단순 개발사가 아니라 '기술 운영 파트너'라고 하나요?",
  a: "RGEO Labs는 단순히 기능만 제작하고 끝나는 구조보다, 출시 이후 운영·개선·AI 검색 노출까지 함께 이어가는 방식을 중요하게 생각합니다. 빠르게 만들고 실제 반응을 보며 지속적으로 개선하는 구조를 지향합니다."
}, {
  q: "GEO란 무엇인가요?",
  a: "GEO(Generative Engine Optimization)는 ChatGPT·Perplexity·Google AI 같은 생성형 AI 검색 환경에서 브랜드와 서비스가 더 잘 이해되고 언급될 수 있도록 구조화하는 최적화 방식입니다."
}, {
  q: "GEO·SEO는 왜 개발 단계부터 함께 해야 하나요?",
  a: "웹사이트 구조, FAQ, 콘텐츠 흐름, 메타 정보는 처음 설계될 때부터 함께 고려해야 AI와 검색엔진이 더 쉽게 이해할 수 있습니다. 나중에 추가하는 것보다 개발 단계에서 함께 설계하는 것이 훨씬 효율적입니다."
}, {
  q: "개발자 채용 대비 어떤 점이 다른가요?",
  a: "개발자 채용에는 연봉 외에도 채용 기간, 4대보험, 장비, 운영 비용, 이직 리스크가 발생합니다. RGEO Labs는 월 구독 기반으로 개발·운영·GEO·SEO까지 하나의 팀으로 대응해 초기 부담과 운영 리스크를 낮출 수 있습니다."
}, {
  q: "초기 개발비 0원으로도 가능한가요?",
  a: "프로젝트 규모와 협업 방식에 따라 초기 구축 비용 부담 없이 시작 가능한 경우가 있습니다. 다만 이후 월 운영·개발 구독 비용은 발생하며, 모든 프로젝트가 동일 조건으로 진행되지는 않습니다."
}, {
  q: "앱 개발도 가능한가요?",
  a: "네. 웹서비스, 관리자 시스템, iOS·Android 앱까지 통합적으로 대응합니다. 프로젝트 목적과 예산에 따라 가장 효율적인 방식으로 MVP 구조를 먼저 제안드립니다."
}, {
  q: "이미 운영 중인 서비스도 맡길 수 있나요?",
  a: "가능합니다. 기존 서비스의 유지보수, 기능 개선, 신규 기능 추가, AI 자동화, GEO·SEO 구조 개선까지 함께 진행할 수 있습니다."
}, {
  q: "AI·노코드·바이브 코딩으로 만든 서비스도 운영이 가능한가요?",
  a: "최근에는 AI·노코드·바이브 코딩으로 빠르게 MVP를 만드는 경우가 많아졌습니다. 하지만 실제 운영 단계에서는 유지보수, 확장성, 배포 구조, 데이터 관리 문제가 발생하는 경우도 많습니다. RGEO Labs는 빠른 제작뿐 아니라 장기적으로 운영 가능한 구조까지 함께 고려합니다."
}, {
  q: "월 구독형 개발은 어떻게 진행되나요?",
  a: "상담 후 필요한 기능과 우선순위를 먼저 정리하고, 월 단위로 개발·수정·배포·운영 개선을 이어갑니다. 처음부터 크게 만들기보다 작게 출시하고 빠르게 개선하는 방식을 권장합니다."
}];
const $$splitComponentImporter = () => import("./index-B3rfuiES.js");
const FAQ_JSONLD = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
...
const SERVICE_JSONLD = {
  ...
  areaServed: "KR",
  description: "RGEO Labs(알지오랩스)는 개발자 채용 없이 웹·앱·AI 서비스를 시작할 수 있도록 돕는 AI 시대의 기술 운영 파트너입니다. 웹·앱·MVP 개발부터 유지보수, AI 자동화, GEO·SEO 구조 설계까지 하나의 팀이 함께합니다. 초기 구축 비용 부담을 낮춘 월 구독형 개발 구조와 기술 투자형 협업도 제공합니다. 또한 AI 검색 환경에서도 발견될 수 있도록 구조화 데이터와 GEO 기반으로 설계합니다.",
  offers: {
    "@type": "Offer",
    priceCurrency: "KRW",
    availability: "https://schema.org/InStock",
    description: "월 구독형 개발·운영 구조 · 초기 비용 부담 완화 · 기술 투자형 협업 가능"
  }
};
const ORG_JSONLD = {
  "@context": "https://schema.org",
...
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "RGEO Labs(알지오랩스)는 개발자 채용 없이 웹·앱·MVP 개발, AI 자동화, 유지보수, GEO·SEO 최적화를 함께 제공하는 월 구독형 기술 운영 파트너입니다."
    }, {
      property: "og:title",
      content: "RGEO Labs(알지오랩스) — 월 구독형 개발·운영 파트너"
    }, {
      property: "og:description",
      content: "개발자 채용 대신 월 구독으로 웹·앱·MVP 개발부터 AI 자동화, GEO·SEO 구조 설계까지 한 팀이 함께합니다."
    }, {
      property: "og:image",
