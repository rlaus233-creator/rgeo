...
const faqs = [
  ...
  { q: "초기 개발비 0원으로도 시작할 수 있나요?", a: "네, 대부분 초기 구축 비용 없이 시작합니다. 한 번에 크게 받고 끝내는 외주와 달리, 개발·운영을 월 구독에 함께 담기 때문입니다. 큰돈을 앞에 깔지 않고, 서비스가 성장하는 만큼 함께 가는 구조입니다. (월 구독 비용은 발생하며, 프로젝트 범위에 따라 조건은 달라질 수 있습니다.)" },
